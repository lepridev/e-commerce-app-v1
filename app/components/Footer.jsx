      ...
      <div className="border-b w-full flex flex-col md:flex-row md:justify-between gap-3">
        ...
        <div className="flex-1 flex flex-col md:flex-row justify-end gap-4">
          <div className="flex gap-2 items-center">
            ...
            <h2 className="text-sm text-gray-600">+225 07 122 078 90</h2>
          </div>
          <div className="flex gap-2 items-center">
            <Mail size={12} className="text-blue-500" />
            <h2 className="text-sm text-gray-600">contact@exemple.com</h2>
          </div>
          <div className="flex gap-2 items-center">
            <MapPin size={12} className="text-blue-500" />
            <h2 className="text-sm text-gray-600">Abidjan-RCI</h2>
          </div>
        </div>
      </div>
      <div className="flex justify-center w-full">
        <h3 className="text-xs text-gray-700">
          © 2025 . Tous droits réservés par [LEPRIDEV]
        </h3>
      </div>
    </footer>
  );
