      ...
      <section className="flex flex-col gap-6 w-full max-w-md">
        ...
        <div className="flex flex-col gap-6 bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
          <div className="text-center">
            <h1 className="font-bold text-2xl text-gray-800">Connexion</h1>
          ...
          <div className="flex justify-between items-center pt-4 border-t border-gray-200">
            <Link href={`/sign-up`}>
              <button className="font-medium text-sm text-blue-600 hover:text-blue-700 transition-colors">
                Créer un compte
              </button>
            </Link>
            <Link href={`/forget-password`}>
              <button className="font-medium text-sm text-gray-600 hover:text-gray-700 transition-colors">
                Mot de passe oublié ?
              </button>
            </Link>
          </div>
...
function SignInWithGoogleComponent() {
  ...
  return (
    <Button
      ...
      isDisabled={isLoading}
      onClick={handleLogin}
      className="w-full py-3 bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 font-medium flex items-center justify-center gap-3 transition-all"
      variant="bordered"
    >
      {!isLoading && (
